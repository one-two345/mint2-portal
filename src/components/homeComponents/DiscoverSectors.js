  ...
  return (
    <div className="container shadow p-4 mb-3 mt-3" style={{ background: '#2b2b2b', color: "white"}}>
      ...
      <div className="col-md-6">
          ...
          <a href = "/institutes" style={{marginLeft: "200px", color: "white", backgroundColor:"black", marginTop:"30px", marginBottom:'20px'}}  className="btn btn-warning  ">Connect with institutes</a>
        </div>
